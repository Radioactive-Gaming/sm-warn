/**
 * sm_warn.sp
 * Written for SourceMod 1.12 and Source TF2 build 10680128.
 * https://developer.valvesoftware.com/wiki/Source/Engine_versions
 *
 * The SM Warn plugin adds the ability to warn players through SourceBans++
 * without banning or kicking them, but still tracks the moderation actions.
 *
*/
#pragma semicolon 1
...
Handle DHhostname;
Handle hAdminMenu;
Handle g_cVar_maxwarns;
Handle g_cVar_max_punishment;
Handle g_cVar_banlength;
Handle g_cVar_punishment;
Handle g_cVar_slapdamage;
Handle g_cVar_PrintToAdmins;
Handle g_cVar_LogWarnings;
Handle g_cVar_warnsound;
Handle g_cVar_warnsoundPath;
Handle g_cVar_motdpanel;
Handle g_cVar_warnpaneltitel;
Handle g_cVar_warnpanelurl;
...
{
	name = "SM warn",
	author = "ecca, Sarrus, CaptainUndies",
	description = "Warn players when they are doing something wrong.",
	version = PLUGIN_VERSION,
	url = "https://github.com/Radioactive-Gaming/sm-warn"
};
